...
class OtpStartride extends StatefulWidget {
  const OtpStartride({super.key});

  @override
  State<OtpStartride> createState() =>
      _OtpStartrideState();
}

class _OtpStartrideState extends State<OtpStartride> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Enter your OTP to start the ride',
